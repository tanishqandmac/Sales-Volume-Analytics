CALLBACKURL = "https://0bbe8472.ngrok.io/webhooks"
...
{
  webhookSubscriptions(first:1, callbackUrl:"https://0bbe8472.ngrok.io/webhooks"){
    edges{
      node{
        id
      }
          ...
          id
                ...
                ''',
                  "variables": {
                    ...
                    "webhookSubscription": {"callbackUrl": "https://0bbe8472.ngrok.io/uninstall"}
                  }
                }
